...
type Client interface {
	...
	// Get(url string, headers ...http.Header) (*Response, error) but then you just choose only the first one... seems odd haha
...
func (c *httpClient) Head(url string, headers ...http.Header) (*Response, error) {
